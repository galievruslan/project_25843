class Places < ActiveRecord::Migration
  def self.up
    ...
    create_table :regions do |t|
     ...
     # execute "LOAD DATA INFILE '#{Rails.root}/db/migrate/Countries.txt' INTO TABLE Countries FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;"

     # execute "LOAD DATA INFILE '#{Rails.root.to_s}/db/migrate/Regions.txt' INTO TABLE regions
     #   FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;"

     # execute "LOAD DATA INFILE '#{Rails.root.to_s}/db/migrate/cities.txt' INTO TABLE cities
     #   FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;"
