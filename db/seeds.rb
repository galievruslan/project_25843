...
city2 = City.create(name: "Yoshkar-Ola", latitude: "56.637", longitude: "47.871", timezone: "+04:00", dma_id: "0", code: "YOSH", country: country1 , region: region2)
city3 = City.create(name: "Texas City", latitude: "29.3942", longitude: "-94.9343", timezone: "-06:00", dma_id: "618", code: "TCIT", country: country2 , region: region3)
city4 = City.create(name: "Harrisburg", latitude: "35.3285", longitude: "-80.661", timezone: "-05:00", dma_id: "517", code: "HARR", country: country2 , region: region4)
@user1 = User.create(username: 'admin', password: '123456', password_confirmation: '123456', city: city1, birth_date: '01-10-1986', gender: 'male', email: 'test@gmail.com', region: region1, country: country1)